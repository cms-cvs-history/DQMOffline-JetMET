...
#        "HLT_MinBias"),
    ...
    lowPtJetTrigger = cms.PSet(
        ...
        hltPaths       = cms.vstring( 'HLT_Jet80_v2' ), 
        andOrHlt       = cms.bool( False ),
        errorReplyHlt  = cms.bool( False ),
    ),
    minBiasTrigger = cms.PSet(
        ...
        hltPaths       = cms.vstring( 'HLT_L1Tech_BSC_minBias_threshold1_v3' ), 
        andOrHlt       = cms.bool( False ),
        errorReplyHlt  = cms.bool( False ),
    ),
    highMETTrigger = cms.PSet(
        ...
        hltPaths       = cms.vstring( 'HLT_MET200_v2' ), 
        andOrHlt       = cms.bool( False ),
        errorReplyHlt  = cms.bool( False ),
    ),
    lowMETTrigger = cms.PSet(
        ...
        hltPaths       = cms.vstring( 'HLT_MET100_v2' ), 
        andOrHlt       = cms.bool( False ),
        errorReplyHlt  = cms.bool( False ),
    ),
    eleTrigger = cms.PSet(
        ...
        hltPaths       = cms.vstring( 'HLT_Ele27_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_v3' ), 
        andOrHlt       = cms.bool( False ),
        errorReplyHlt  = cms.bool( False ),
    ),
    muonTrigger = cms.PSet(
        ...
        hltPaths       = cms.vstring( 'HLT_IsoMu17_v6' ), 
        andOrHlt       = cms.bool( False ),
        errorReplyHlt  = cms.bool( False ),
    ),
